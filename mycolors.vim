...
if &background == "dark"
  ...
  SynColor Visual      term=bold cterm=NONE ctermfg=Black ctermbg=Yellow gui=NONE guifg=Blue guibg=NONE
  SynColor Comment      term=bold cterm=NONE ctermfg=Cyan ctermbg=NONE gui=NONE guifg=Blue guibg=NONE
